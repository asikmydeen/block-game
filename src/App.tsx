...
const MODES: ModeCard[] = [
  {
    ...
    icon: '·',
    title: 'Free Play',
    desc: 'Roam the city. Build, drive, hunt — no clock, no objectives.',
    color: '#2e8b57',
    titleColor: '#8affc1',
  },
  {
    ...
    icon: '25',
    title: 'Levels',
    desc: '25 timed jobs. Finish the objective before the clock hits zero.',
    color: '#c9a53d',
    titleColor: '#ffd76a',
  },
  {
    ...
    icon: 'vs',
    title: 'Multiplayer',
    desc: 'Race the same level. First to finish the objective in time wins.',
    color: '#1e6fd0',
    titleColor: '#7cc4ff',
  },
];
